<div class="m-4">
  ...
  <div class="m-4">
    <div visible max-md:hidden>
      cool pics coming soon
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <div class="card card-compact bg-base-100 w-96 shadow-xl hidden lg:visible">
        <div class="stack p-4 w-200">
        ...
        <div class="card-body">
          ...
          <p>Maybe have some more info here?</p>
        </div>
      </div>
    </div>
  </div>
